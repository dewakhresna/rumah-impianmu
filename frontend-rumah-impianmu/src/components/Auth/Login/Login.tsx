...
import { useLogin } from "./useLogin"; // Import Logic
...
export const Login = () => {
  ...
  const { identifier, setIdentifier, password, setPassword, isLoading, errorMsg, handleLogin } = useLogin();
    ...
    <>
      ...
      <div className="min-h-screen flex bg-white font-sans text-slate-900">
          ...
          <div className="w-full max-w-md mt-12 lg:mt-0">
            ...
            <form className="flex flex-col gap-6" onSubmit={handleLogin}>
              ...
              <Input
                ...
                endContent={
                  <button className="focus:outline-none" type="button" onClick={toggleVisibility}>
                    {isVisible ? <EyeOff size={18} className="text-slate-400" /> : <Eye size={18} className="text-slate-400" />}
                  </button>
                }
                variant="bordered"
                radius="lg"
              ...
              <div className="flex items-center justify-between mt-2">
                <Checkbox size="sm" classNames={{ label: "text-slate-600 text-sm" }}>
                  Ingat saya
                </Checkbox>
        ...
        <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 overflow-hidden">
          <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=2000" alt="Modern Building" className="absolute inset-0 w-full h-full object-cover opacity-40 mix-blend-overlay" />
          ...
          <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24 w-full">
            <h2 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">Kelola properti dengan lebih cerdas.</h2>
            <p className="text-lg text-blue-100 max-w-lg mb-12">Akses analitik real-time, kelola listing, dan tanggapi pesan klien Anda secara langsung dari satu dashboard terpusat.</p>
          </div>
        </div>
      </div>
    </>

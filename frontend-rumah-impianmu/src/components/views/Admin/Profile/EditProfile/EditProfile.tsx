...
import { Card, Input, Button, Avatar, Divider } from "@heroui/react";
import {
  User,
  Mail,
  Camera,
    ...
    <div className="flex flex-col items-center justify-center gap-4">
      <div className="relative group cursor-pointer">
        <Avatar
          ...
          className="w-32 h-32 text-large border-4 border-blue-50 shadow-md transition-transform duration-300 group-hover:scale-105 group-hover:shadow-lg group-hover:border-blue-100"
        />
        {/* Hover Overlay */}
...
const ProfileForm = () => {
  // Shared input styling to maintain strict design consistency
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-2xl mx-auto">
      ...
      <Input
        ...
        classNames={inputClassNames}
        defaultValue="sarah.wijayanto@estateprime.com"
      />
    </div>
  );
};

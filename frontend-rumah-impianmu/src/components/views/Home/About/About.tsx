...
const HeroSection = () => (
  <section className="relative px-6 py-20 md:py-32 flex flex-col items-center text-center bg-gradient-to-b from-blue-50 to-slate-50 rounded-b-3xl">
    ...
    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 max-w-4xl mb-6 leading-tight">
      Temukan Rumah Impian Anda dengan{" "}
      <span className="text-blue-600">Percaya Diri</span>
    </h1>
    <p className="text-lg md:text-xl text-slate-500 max-w-2xl mb-10 leading-relaxed">
      Platform kami membantu pengguna menemukan properti terbaik melalui
      pengalaman pencarian yang intuitif dan sistem rekomendasi cerdas. Kami
      membuat pencarian rumah ideal Anda menjadi lebih mudah, lebih cepat, dan
      lebih terpercaya.
    </p>
    <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
      <Button
        ...
        color="primary"
        size="lg"
        className="bg-blue-600 rounded-xl font-medium shadow-md shadow-blue-500/20 hover:scale-105 hover:shadow-lg transition-all duration-300 px-8 h-14"
      >
        Jelajahi Properti
      </Button>
      <Button
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div className="flex flex-col gap-6">
        ...
        <p className="text-lg text-slate-600 leading-relaxed">
          Kami adalah platform rekomendasi properti premium yang dirancang untuk
          menyederhanakan perjalanan pembelian rumah. Dengan menggabungkan
          teknologi modern dan sistem pendukung keputusan yang cerdas, kami
          membantu pengguna membandingkan properti secara efisien dan percaya
          diri.
        </p>
        <p className="text-lg text-slate-600 leading-relaxed">
          Baik Anda seorang pembeli pertama maupun investor berpengalaman,
          daftar pilihan kami yang dikurasi serta algoritma cerdas memastikan
          Anda menemukan rumah yang sangat cocok dengan gaya hidup dan anggaran
          Anda.
        </p>
      </div>
    </div>
...
const MissionSection = () => {
  const missions = [
    {
      icon: <Target size={32} />,
      title: "Informasi Properti Terpercaya",
      desc: "Kami memastikan semua daftar properti telah diverifikasi, akurat, dan terbaru.",
    },
    {
      icon: <Search size={32} />,
      title: "Menyederhanakan Pencarian",
      desc: "Antarmuka intuitif yang dirancang untuk menghemat waktu dan tenaga Anda.",
    },
    {
      icon: <Award size={32} />,
      title: "Memberikan Rekomendasi Cerdas",
      desc: "Wawasan berbasis data untuk mencocokkan Anda dengan rumah idaman.",
    },
  ];
    ...
    <section className="px-6 py-20 max-w-7xl mx-auto text-center">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {missions.map((mission, idx) => (
          <Card
            key={idx}
            className="bg-white border border-slate-200 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-2 hover:border-blue-300 transition-all duration-300 group"
          >
  ...
  const features = [
    {
      ...
      desc: "Setiap properti diperiksa keasliannya secara menyeluruh.",
    },
    {
      icon: <Zap size={24} />,
      title: "Rekomendasi Cerdas",
      desc: "Saran berbasis AI yang disesuaikan dengan preferensi unik Anda.",
    },
    {
      icon: <Search size={24} />,
      title: "Pencarian Super Cepat",
      desc: "Kemampuan pencarian dan penyaringan properti secepat kilat.",
    },
    {
      icon: <Heart size={24} />,
      title: "Properti Favorit",
      desc: "Simpan dan bandingkan pilihan teratas Anda dengan mudah.",
    },
    {
      icon: <MessageSquare size={24} />,
      title: "Kontak Langsung",
      desc: "Berkomunikasi langsung dengan pemilik properti dan agen.",
    },
    {
      icon: <MonitorSmartphone size={24} />,
      title: "Pengalaman Responsif",
      desc: "Penjelajahan tanpa hambatan di desktop, tablet, dan ponsel.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-blue-100 text-lg max-w-2xl mx-auto">
            Temukan berbagai keuntungan yang menjadikan platform kami pilihan
            utama bagi para pembeli rumah.
          </p>
        </div>
  ...
  const criteria = [
    {
      icon: <Award size={24} />,
      title: "Harga",
      desc: "Dievaluasi agar sesuai dengan anggaran Anda secara optimal.",
    },
    {
      icon: <MapPin size={24} />,
      title: "Jarak",
      desc: "Kedekatan dengan pusat kota dan fasilitas penting.",
    },
    {
      icon: <Shield size={24} />,
      title: "Keamanan",
      desc: "Peringkat keselamatan di lingkungan sekitar.",
    },
    {
      icon: <Maximize size={24} />,
      title: "Luas Tanah",
      desc: "Ruang luas yang disesuaikan dengan gaya hidup Anda.",
    },
  ];
        ...
        <CardBody className="p-10 md:p-16 flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2 flex flex-col gap-6">
            ...
            <p className="text-lg text-slate-600">
              ...
              berbagai properti dengan menyeimbangkan berbagai kriteria secara
              mulus.
            </p>
          </div>
          <div className="md:w-1/2 grid grid-cols-2 gap-4 w-full">
            {criteria.map((crit, idx) => (
              <div
                key={idx}
                className="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:border-blue-300 hover:shadow-md transition-all duration-300"
              >
  ...
  const faqs = [
    {
      ...
      a: "Anda dapat menggunakan kolom pencarian intuitif kami di Halaman Utama, memfilter berdasarkan lokasi, harga, dan fasilitas, atau membiarkan mesin rekomendasi cerdas kami menyarankan properti untuk Anda.",
    },
    {
      q: "Apakah platform ini gratis?",
      a: "Ya, menjelajahi properti dan menggunakan alat rekomendasi cerdas kami sepenuhnya gratis untuk semua pengguna.",
    },
    {
      q: "Bagaimana rekomendasi dihitung?",
      a: "Kami menggunakan metode pendukung keputusan TOPSIS, yang secara matematis memberi peringkat properti berdasarkan seberapa dekat mereka dengan kriteria ideal Anda (harga, jarak, keamanan, dll).",
    },
    {
      q: "Bisakah saya menyimpan properti favorit?",
      a: "Tentu saja. Setelah Anda membuat akun gratis, Anda dapat mengklik ikon hati pada listing mana pun untuk menyimpannya ke dasbor pribadi Anda.",
    },
    {
      q: "Bisakah saya menghubungi pemilik properti secara langsung?",
      a: "Ya! Setiap halaman detail properti menyertakan tombol kontak langsung yang menghubungkan Anda seketika dengan pemilik terverifikasi atau agen yang bertugas.",
    },
  ];
    ...
    <Card className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-3xl shadow-xl overflow-hidden border-none">
      <CardBody className="py-20 px-8 text-center flex flex-col items-center">
        ...
        <p className="text-blue-100 text-lg md:text-xl max-w-2xl mb-10">
          Mulai jelajahi ratusan properti yang tersedia hari ini. Babak baru
          kehidupan Anda dimulai di sini.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Button
            as={Link}
